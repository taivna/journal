...
public class master1detail3 extends BaseExpandableListAdapter
{
    TextView listChild1, listChild2, listChild3, listHeader;
    private Context context;
    private List<String> listDataHeader; // header titles
    // child data in format of header title, child title
    private HashMap<String, List<String>> listDataChild;

    public master1detail3(Context context, List<String> listDataHeader, HashMap<String, List<String>> listChildData)
    {
