...
public class Master2Detail2 extends BaseExpandableListAdapter
{
    TextView listChild1, listChild2, listHeader1, listHeader2;
    private Context context;
    private List<String> listDataHeader; // header titles
    // child data in format of header title, child title
    private HashMap<String, List<String>> listDataChild;

    public Master2Detail2(Context context, List<String> listDataHeader, HashMap<String, List<String>> listChildData)
    {
